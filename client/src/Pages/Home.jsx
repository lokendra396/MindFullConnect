...
const Home = () => {
  ...
  //       "https://innercallmserver.onrender.com/allposts",
  //       {
  //         method: "GET",
  //         headers: {
    ...
    <>
      ...
      <section className="share_story">
        <div className="share_story_content">
          ...
          <p>
            If you're feeling sorrow or sadness, don't hesitate to share your
            story with our community. Your words have the power to heal,
            inspire, and uplift others who may be going through similar
            experiences. You are not alone, and together, we can support each
            other on this journey towards healing and well-being.
          </p>
      ...
      <section className="listen_music">
        <div className="listen_music_content">
          <h2>MUSIC HEALS</h2>
          <p>
            Music has the power to heal and soothe our souls. Listening to our
            peaceful music and sounds can bring relaxation, tranquility, and a
            sense of inner peace. It can help reduce stress, anxiety, and
            promote overall well-being. Our carefully curated collection of
            music is designed to elevate your mood, calm your mind, and
      ...
      <section className="about">
        <div className="about_content">
          ...
          <p>
            ...
            individuals to achieve mental and emotional well-being. Our mission
            is to empower individuals with simple and accessible strategies for
            managing stress and cultivating inner peace. Through stories, music,
            and other resources, our team of students is committed to helping
            individuals find tranquility in their daily lives.
          </p>
        </div>
      </section>
